<template>
  <div class="min-h-screen theme-bg-primary text-text-primary relative overflow-hidden">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10 lg:py-12 xl:py-16 grid gap-8 sm:gap-10 lg:gap-12 lg:grid-cols-[1.1fr_0.9fr] items-center min-h-screen">
      <div class="space-y-4 sm:space-y-5 lg:space-y-6 order-2 lg:order-1">
        ...
        <div class="grid sm:grid-cols-2 gap-3 sm:gap-4">
          <div
            ...
            :key="feature.title"
            class="p-3 sm:p-4 rounded-xl sm:rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md"
          >
      ...
      <div class="glass-card p-4 sm:p-6 lg:p-8 rounded-2xl sm:rounded-3xl border border-white/10 shadow-2xl shadow-soft-coral/5 order-1 lg:order-2 w-full">
        ...
        <form @submit.prevent="handleLogin" class="space-y-3 sm:space-y-4">
          ...
          <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 sm:gap-0 text-[0.625rem] sm:text-xs text-text-secondary">
        ...
        <div class="mt-4 sm:mt-5 lg:mt-6 text-center text-text-secondary text-[0.625rem] sm:text-xs lg:text-sm">
